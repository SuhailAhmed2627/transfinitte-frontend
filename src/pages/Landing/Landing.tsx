...
import assistantMockup from "../../assets/mockup.png";
				...
				<div className="grid py-8 px-4 mx-auto max-w-screen-xl lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 max-md:flex max-md:flex-col-reverse">
					<div className="place-self-center mr-auto lg:col-span-7">
						...
						<p className="mb-6 max-w-2xl font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
							Personalize your experience with a virtual assistant that learns your preferences and adapts to your needs.
						</p>
						<a
							href="/login"
				...
				<div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
					<div className="mb-8 max-w-screen-md lg:mb-16">
						...
						<p className="text-gray-500 sm:text-xl dark:text-gray-400">
							Polaris can learn about you to give you a personalized experience
						</p>
					</div>
					<div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
						...
						<div>
							...
							<p className="text-gray-500 dark:text-gray-400">
								Polaris is a good AI. Polaris does not do anything illegal.
							</p>
						</div>
						<div>
							<div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
						...
						<div>
							...
							<p className="text-gray-500 dark:text-gray-400">
								Polaris knows when its wrong. Polaris will make it right.
							</p>
						</div>
					</div>
				</div>
